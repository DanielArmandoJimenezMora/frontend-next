...
const MejoresClientes = () => {
  ...
  const ventaTotalO = clienteGrafica.reduce(
    (total, cliente) => total + (cliente.genero === "Otro" ? cliente.total : 0),
    0
  );
  ...
  return (
    <Layout>
        ...
        <div>
          <div className="flex">
            ...
            <p className="flex shadow mr-4 mt-2 my-2 bg-white border-l-4 border-green-700 text-green-700 p-2 text-sm rounded font-bold w-2/4">
              ...
              <span className="mt-3">
                Compras totales de todos los clientes: ${ventaTotal} pesos.
              </span>
            </p>
            {/* Hombres */}
            <p className="flex shadow mt-2 my-2 bg-white border-l-4 border-cyan-700 text-cyan-700 p-2 text-sm rounded font-bold w-2/4">
              ...
              <span className="mt-3">
                Compra totales hechas por Hombres: ${ventaTotalH} pesos.
              </span>
            </p>
          </div>
          <div className="flex">
            ...
            <p className="flex shadow mr-4 mt-1 my-2 bg-white border-l-4 border-purple-700 text-purple-700 p-2 text-sm rounded font-bold w-2/4">
              ...
              <span className="mt-3">
                Compras totales hechas por Otros: ${ventaTotalO} pesos.
              </span>
            </p>
            {/* Mujeres */}
            <p className="flex shadow mt-1 my-2 bg-white border-l-4 border-pink-500 text-pink-500 p-2 text-sm rounded font-bold w-2/4">
              ...
              <span className="mt-2">
                Compras totales hechas por Mujeres: ${ventaTotalM}
              </span>
            </p>
          </div>
        </div>
      ...
      <ResponsiveContainer
        width="100%"
        height={`${perfil === "Administrador" ? "64%" : "83%"}`}
